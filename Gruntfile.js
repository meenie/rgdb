module.exports = function (grunt) {
    ...
    var taskConfig = {
            ...
            build: {
                files: {
                    '<%= build_dir %>/assets/<%= pkg.name %>.css':
                        ['src/app/**/*.less', '<%= vendor_files.css %>', '<%= app_files.less %>']
                },
                options: {
                    compile: true,
                    compress: false,
        ...
        delta: {
            ...
            less: {
                files: ['src/**/*.less'],
                tasks: ['recess:build', 'string-replace:build']
            },
    ...
    grunt.registerTask('build', [
        ...
        'copy:build_assets', 'copy:build_appjs', 'copy:build_vendorjs', 'string-replace:build',
    ...
    grunt.registerTask('compile', [
        'clean:compile', 'recess:compile', 'copy:compile_assets', 'copy:compile_vendor_files',
